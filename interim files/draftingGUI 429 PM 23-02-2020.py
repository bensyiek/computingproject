    ...
    def slideChoicesAcross(self,loop=0):
        if loop == 0:
            ...
            for x in range(0,18):
                ...
                xOffset = (xOffset + 96) % 480 ##loops aorund when x gets bigger than 480
                yOffset = (yOffset) + 96*int((x%5+1)/5) ##adds 80 whenever next x is divisible by 6- i.e. when we've plotted 6 items in a row
