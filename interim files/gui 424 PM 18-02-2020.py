...
#------------------------------------------------------------------------------------------------------------------------------#
    ...
    def tablet_displayEnemyPokemon(self,pkmn):
        ...
        self.tabletCanvas.create_text(20,240,text='Moves: ',font=self.tabletFont,anchor=W,tags=('tablet-data','tablet-pokemon-moves'))
        ...
        for move in moves:
            ...
            first = -20
            for phrase in desc:
                self.tabletCanvas.create_text(40+first,260+count*20,text=phrase,font=self.smallTabletFont,anchor=W,tags=('tablet-data','tablet-pokemon-moves-'+str(count)))
                first = 0
                count += 1
    ...
    def tablet_displayMove(self,move):
        ...
        if move.category != 'Status':
            self.tabletCanvas.create_text(20,300+count*30,text='Power: ' + move.power,font=self.tabletFont,anchor=W,tags=('tablet-data','tablet-move-type'))
...
#------------------------------------------------------------------------------------------------------------------------------#
    ...
    def loadButtonsFirstTime(self):
        ...
        for count in range(4):
            self.moveButtons.append(Button(self.buttonFrame,bg='white',text=' ',width=9,height=3,font=self.DPPtFont2,state=DISABLED))
        ...
        for count in range(6):
            ...
            self.switchButtons.append(Button(self.buttonFrame,height=60,width=76,state=DISABLED,bg='white',image=self.switchButtonsImages[-1]))
    ...
    def updateButtons(self):
        ...
        for button in self.switchButtons:
            if count != arena.userTrainer.active and arena.userTrainer.team[str(count)] != None:
                ...
                button.bind('<Enter>',k)
                if arena.userTrainer.team[str(count)].fainted == False:
