                        ...
                        for hit in range(0,loop):
                            if self.doesMoveHit(x[1],user,targ):
                                if targ.lastUsedProtect:
                                    ...
                                    q.add(k)
                                    break
                                if move.name == 'Fake Out' and not user.switchedInThisTurn:
...
class move:
    ...
    def acrobatics(self,arena,user,targ):
        arena.app.taskFinished = True
    ...
    def aquaJet(self,arena,user,targ):
        arena.app.taskFinished = True
    ...
    def chipAway(self,arena,user,targ):
        arena.app.taskFinished = True
    ...
    def dualChop(self,arena,user,targ):
        arena.app.taskFinisehd = True
    ...
    def machPunch(self,arena,user,targ):
        arena.app.taskFinished = True
    ...
    def slash(self,arena,user,targ):
        arena.app.taskFinished = True
    ...
    def venoshock(self,arena,user,targ):
        arena.app.taskFinished = True
