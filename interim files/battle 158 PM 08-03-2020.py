                ...
                ##THE FOLLOWING TWO ARE ENTRY HAZARDS. THEY ACTIVATE WHEN A POKEMON SWITCHES IN AND THEY ARE ACTIVE.
                    ...
                    if self.stealthRock[self.userTrainer]:
                        ...
                        if damage >= pkmn.hp:
                            ...
                            q.add(genFunc(self.apprunText,pkmn.name + ' fainted!'))
                        else:
                    ...
                    if self.stealthRock[self.enemyTrainer]:
                        ...
                        if damage >= pkmn.hp:
                            ...
                            q.add(k)
                            self.faintedMidBattle[1] = True
                            q.add(genFunc(self.apprunText,"Foe's " + pkmn.name + ' fainted!'))
                        else:
                            pkmn.stealthRockDamage = damage
                            ...
                            if self.doesMoveHit(x[1],user,targ):
                                ...
                                if x[1].category != 'Status':
                                    ...
                                    if damage[1] == 0:
                                        ...
                                        if x[1].name in ['Air Slash','Clear Smog','Dark Pulse','Dragon Rush','Drain Punch','Extrasensory','Fake Out','Fire Fang','Giga Drain','Heal Bell','Ice Fang','Icicle Crash','Iron Head','Rapid Spin','Rest','Rock Slide','Roost','Synthesis','Thunder Fang','Waterfall','Zen Headbutt']:
                                    ...
                                    elif x[1].name in ['Sleep Powder','Spore','Hypnosis','Clear Smog','Protect','Taunt']:
...
#############################################################
    ...
    def findDamage(self,user,target,move):
        ...
        if move.name == 'Hex' and (target.statusCondition in ['poisoned','badly poisoned','burned','freeze','paralyzed','asleep']):
            ...
            P = min(150,int(25*targ.stats[5]/user.stats[5]))
...
class move:
    def __init__(self,name,pokemon):
        ...
        moveSpecifier = {'Bone Rush' : 'multihit','Brave Bird':'recoil',    'Bullet Seed' : 'multihit','Dual Chop' : 'twohit','Icicle Spear':'multihit','Pin Missile':'multihit','Rock Blast':'multihit'}
