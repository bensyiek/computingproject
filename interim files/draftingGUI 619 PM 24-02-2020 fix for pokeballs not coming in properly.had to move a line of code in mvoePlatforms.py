...
#------------------------------------------------------------------------------------------------------------------------------#
    ...
    def choices_boxSelection(self,coords,offset=0,sign=0.1,posOrNeg=-0.02): ##pops up a small green box around the user's choice
        ...
        self.battleCanvas.create_image(coords[0]+1-offset,coords[1]+4-offset,image=self.choices_boxImageTL,anchor=S,tags=('selection-box'))
        self.battleCanvas.create_image(coords[0]+89+offset,coords[1]+4-offset,image=self.choices_boxImageTR,anchor=S,tags=('selection-box'))
        self.battleCanvas.create_image(coords[0]+1-offset,coords[1]+92+offset,image=self.choices_boxImageBL,anchor=S,tags=('selection-box'))
        self.battleCanvas.create_image(coords[0]+89+offset,coords[1]+92+offset,image=self.choices_boxImageBR,anchor=S,tags=('selection-box'))
        if int(sign*10) == -1:
            posOrNeg = 0.02
        elif int(sign*10) == 1:
            posOrNeg = -0.02
