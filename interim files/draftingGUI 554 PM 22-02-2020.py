...
#------------------------------------------------------------------------------------------------------------------------------#
    ...
    def boxSelection(self,coords,offset=0,sign=2.5,posOrNeg=-0.5): ##pops up a small green box around the user's choice
        ...
        self.battleCanvas.create_image(coords[0]-82.5-offset,coords[1]-112.5-offset,image=self.boxImageTL,anchor=S,tags=('selection-box'))
        self.battleCanvas.create_image(coords[0]+82.5+offset,coords[1]-112.5-offset,image=self.boxImageTR,anchor=S,tags=('selection-box'))
        self.battleCanvas.create_image(coords[0]-82.5-offset,coords[1]+32.5+offset,image=self.boxImageBL,anchor=S,tags=('selection-box'))
        self.battleCanvas.create_image(coords[0]+82.5+offset,coords[1]+32.5+offset,image=self.boxImageBR,anchor=S,tags=('selection-box'))
