                            ...
                            if self.doesMoveHit(x[1],user,targ):
                                ...
                                if x[1].category != 'Status':
                                    ...
                                    if damage[1] == 0:
                                        ...
                                        if x[1].name in ['Air Slash','Clear Smog','Dark Pulse','Dragon Rush','Drain Punch','Extrasensory','Fake Out','Fire Fang','Giga Drain','Ice Fang','Icicle Crash','Iron Head','Rapid Spin','Rest','Rock Slide','Roost','Synthesis','Thunder Fang','Waterfall','Zen Headbutt']:
                                        ...
                                        if damage[0] >= targ.hp - loopDamage + targ.healthRestored - targ.stealthRockDamage: ##loop damage is for looping moves that deal damage across multiple hits, healthRestored is for moves like rest drainpunch or gigadrain that if not accounted for might incorrectly call a KO animation
                                            ...
                                            if x[2]=='user':
                                                ...
                                                if damage[1] == 2:
                                                    ...
                                                    u = 'weak'
                                                k = genFunc(self.app.HPUpdateEnemy,0,1,0,False,u)
                                                q.add(k)
                                            else:
                                                u = 'regular'
                                                if damage[1] == 2:
                                                    ...
                                                    u = 'weak'
                                                k = genFunc(self.app.HPUpdateUser,0,1,0,False,u)
                                                q.add(k)
                                            ...
                                            if damage[1] == 2:
                                                ...
                                                u = 'weak'
                                            if x[2] == 'user':
                                                k = genFunc(self.app.HPUpdateEnemy,targ.hp-damage[0]-loopDamage,1,0,False,u)
                                            else:
                                                k = genFunc(self.app.HPUpdateUser,targ.hp-damage[0]-loopDamage,1,0,False,u)
                                            q.add(k)
                                            k = genFunc(targ.takeDamage,damage[0])
                                            q.add(k)
                                            if damage[1] == 1:
...
#############################################################
    ...
    def typeModifiers(self,user,target,move):
        ...
        chance = 16
        if move.name in ['Blaze Kick','Cross Poison','Drill Run','Leaf Blade','Night Slash','Shadow Claw','Slash','Stone Edge']:
            chance = 8
...
class move:
    def __init__(self,name,pokemon):
        ...
        moveSpecifier = {'Bone Rush' : 'multihit','Bullet Seed' : 'multihit','Dual Chop' : 'twohit','Icicle Spear':'multihit','Pin Missile':'multihit','Rock Blast':'multihit'}
        for x in ['Wish','Whirlwind','Trick Room','Synthesis','Swords Dance','Shell Smash','Sticky Webs','Stealth Rock','Roost','Rest','Reflect','Light Screen','Hibernate','Double Team','Calm Mind','Amnesia','Agility']:
