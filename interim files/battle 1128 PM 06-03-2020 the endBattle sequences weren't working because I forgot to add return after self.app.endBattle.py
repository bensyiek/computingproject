                            ...
                            if self.doesMoveHit(x[1],user,targ):
                                ...
                                if x[1].category != 'Status':
                                    ...
                                    if damage[1] == 0:
                                        ...
                                        if x[1].name in ['Air Slash','Clear Smog','Dark Pulse','Dragon Rush','Drain Punch','Fake Out','Fire Fang','Giga Drain','Ice Fang','Icicle Crash','Iron Head','Rest','Rock Slide','Roost','Synthesis','Thunder Fang','Waterfall','Zen Headbutt']:
                                    ...
                                    elif x[1].name in ['Spore','Hypnosis','Clear Smog','Protect','Taunt']:
...
#############################################################
    ...
    def typeModifiers(self,user,target,move):
        ...
        chance = 16
        if move.name in ['Blaze Kick','Cross Poison','Leaf Blade','Night Slash','Shadow Claw','Slash','Stone Edge']:
            chance = 8
